/** Singapore public holidays (2025–2026). Shared by the startup auto-seed and
 * the manual seed script so there is a single source of truth. Client-safe. */
export interface SeedHoliday {
  date: string // YYYY-MM-DD (Singapore)
  name: string
}

export const SINGAPORE_HOLIDAYS: SeedHoliday[] = [
  // 2025
